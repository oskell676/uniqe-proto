// UNIQE service worker — only exists to make the app installable and to
// receive Web Push notifications. No offline caching (prototype scope).
...
self.addEventListener("push", (event) => {
  let payload = { title: "UNIQE", body: "Noen tenkte på deg." };
  if (event.data) {
    try {
